<template>
        ...
        <div class="page-banner bg-light">
            <div class="container">
                <div class="page-banner-content text-center">
                    <h2 class="title">{{$t('products.product3.name')}}</h2>
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$t('products.product3.name')}}</li>
                    </ol>
                </div>
            </div>
        </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="@/assets/images/product/HaridraTablet.jpg" alt="Product Image">
    </div>
    ...
    <span class="sr-only">Next</span>
                    ...
                    <div class="col-lg-6">
                        <div class="shop-single-content">
                            <h3 class="title">{{$t('products.product3.name')}}</h3>
                            ...
                            <div>
								<p>
								{{$t('products.product3.translation')}}
								</p>

								<div>
									 <p class="font-weight-bold">{{$t('products.product3.description.indication.name')}}</p>
									 <p>
										 <ul class="bullets">
											<li>{{$t('products.product3.description.indication.line1')}}</li> 
											<li>{{$t('products.product3.description.indication.line2')}}</li>
											<li>{{$t('products.product3.description.indication.line3')}}</li>
										</ul>
									 </p>
								</div>
								<br>
								<div>
									<p class="font-weight-bold">{{$t('products.product3.description.ingridents.name')}}</p>
									<p>{{$t('products.product3.description.ingridents.text')}}</p>
								</div>
								<br>
								<div>
									<p class="font-weight-bold">{{$t('products.product3.description.dosage.name')}}</p>
									<p>
										<ul class="bullets">
											<li v-html="$t('products.product3.description.dosage.line1')"></li> 
											<li v-html="$t('products.product3.description.dosage.line2')"></li>
											<li v-html="$t('products.product3.description.dosage.line3')"></li>
										</ul>
									</p>
								</div>

								<p>
								<span class="font-weight-bold">{{$t('products.product3.description.note.name')}}</span> {{$t('products.product3.description.note.text')}}
								</p>																  

								<p>
									{{$t('products.product3.orderText')}}
								</p>

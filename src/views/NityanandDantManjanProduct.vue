<template>
        ...
        <div class="page-banner bg-light">
            <div class="container">
                <div class="page-banner-content text-center">
                    <h2 class="title">{{$t('products.product4.name')}}</h2>
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{$t('products.product4.name')}}</li>
                    </ol>
                </div>
            </div>
        </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="@/assets/images/product/NityanandDantManjan.jpg" alt="Product Image">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="@/assets/images/product/NityanandDantManjan2.jpg" alt="Product Image">
    </div>
  </div>
    ...
    <span class="sr-only">Next</span>
                    ...
                    <div class="col-lg-6">
                        <div class="shop-single-content">
                            <h3 class="title">{{$t('products.product4.name')}}</h3>
                            ...
                            <div>
								<p>
								{{$t('products.product4.translation')}}
								</p>

								<div>
									 <p class="font-weight-bold">{{$t('products.product4.description.indication.name')}}</p>
									 <p>
										 <ul class="bullets">
								...
								<br>
								<div>
									<p class="font-weight-bold">{{$t('products.product4.description.ingridents.name')}}</p>
									<p>{{$t('products.product4.description.ingridents.text')}}</p>
								</div>
								<br>
								<div>
									<p class="font-weight-bold">{{$t('products.product4.description.dosage.name')}}</p>
									<p>
										<ul class="bullets">
